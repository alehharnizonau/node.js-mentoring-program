...
import {getHealthCheckRoute as healthCheckController} from "./healthCheck.controller";

export {cartsController, productsController, userController, healthCheckController};